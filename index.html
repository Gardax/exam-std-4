      ...
      <div class="table-row">
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="ptab">Понятието „информационни технологии“ в съвременния си смисъл е използвано за пръв път през 1958
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="ptab">В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="ptab">Информационните технологии използват за обработка и съхранение на информация електронноизчислителни машини – компютри.
  ...
  <section class="hoc container clear">
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="ptab">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="ptab">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono.
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="ptab">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#.
